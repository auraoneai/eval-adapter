...
- Parse real YAML run configs in the CLI and keep JSON config support for explicit `.json` files.
- Require hardened `rubric-spec>=0.1.1` for published package installs.
